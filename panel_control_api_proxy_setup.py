...
def main() -> int:
    ...
    parser.add_argument(
        "--basic-auth",
        action="store_true",
        help="Activa Basic Auth de Apache delante de NicePanel",
    )
    parser.add_argument("--auth-user", default="nicepanel", help="Usuario de Basic Auth")
    parser.add_argument("--auth-password", default="", help="Password de Basic Auth")
    ...
    result = setup_api_proxy(
        APIProxyConfig(
            ...
            enable_basic_auth=args.basic_auth,
